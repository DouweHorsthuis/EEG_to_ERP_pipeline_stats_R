...
for s=1:nsubj
    ...
    EEG  = pop_editeventlist( EEG , 'AlphanumericCleaning', 'on', 'BoundaryNumeric', { -99}, 'BoundaryString', { 'boundary' }, 'List', '\\data.einsteinmed.org\users\Ana and Douwe\22Q\Visual gating\scripts\eventlist.txt', 'SendEL2', 'EEG', 'UpdateEEG', 'on', 'Warning', 'off' );
    EEG = eeg_checkset( EEG );
    ...
    participant_info           = [participant_info; data_subj];
end;
save([home_path name_paradigm '_participant_epoching_cleaing_info'], 'participant_info');
