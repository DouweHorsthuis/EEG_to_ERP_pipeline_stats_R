...
% ------------------------------------------------
subject_list = {'9109' '9182' '9182' '12091' '12709' '12883'};
home_path    = 'C:\Users\douwe\Desktop\DATA\'; %place data is (something like 'C:\data\')
save_path    = 'C:\Users\douwe\Desktop\processed\'; %only for the first script, in case you load your data from somewhere special but want to save it somewhere else
readme_file  ='yes';%'yes' or 'no', if yes using [EEG]= readme_to_EEG(EEG, data_path) to read  readme file
eye_tracking ='yes';%'yes' or 'no', if yes using edf_to_figure(data_path)to create a figure with avg gaze
Pausing_yn='n'; %y or n,if you want to first only run people with one block, which is how data is usually collected in our lab, it'll pause if it finds more files
