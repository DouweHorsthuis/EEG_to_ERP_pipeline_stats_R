...
home_path_bdf    = 'C:\Users\douwe\Desktop\DATA\'; %place data is (something like 'C:\data\')
...
for s = 1:length(subject_list)
    ...
    data_path  = [home_path_bdf subject_list{s} '\'];
    save_path_indv=[home_path subject_list{s} '\'];
